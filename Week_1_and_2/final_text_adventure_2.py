print("You wake up one morning and find that you arent in your bed; you arent even in your room. Youre in the middle of a giant maze. A sign is hanging from the ivy: You have one hour. Dont touch the walls. There is a hallway to your right and to your left.")
...
while(user_input != 'left' and user_input != 'right'):
	user_input= input("That was not one of the choices given! Try Again: ")
...
if user_input == "left":
	...
	user_input= input()
	while(user_input != '30 mins' and user_input != 'next step'):
		user_input= input("That was not one of the choices given! Try Again!: ")
	...
	if user_input== "30 mins":
		...
		user_input= input()
		while(user_input != 'fight' and user_input != 'follow'):
			user_input= input("That was not one of the choices given! Try Again: ")
		...
		if user_input== "fight":
			...
			user_input= input()
			while(user_input != 'go through wall' and user_input != 'pocket it'):
				user_input= input("Try Again! That was not one of the choices given! try again: ")
			...
			if user_input== "go through wall":
				...
				user_input= input()
				while(user_input != 'kill' and user_input != 'trust and follow'):
					user_input= input("Try Again! That was not one of the choices given! Try Again!: ")
